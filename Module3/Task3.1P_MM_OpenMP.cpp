// Task 3.1 Matrix Multiplication - Part 2 OpenMP (based on lecture 7 example)
// Program run on Deakin Remote Lab - VMs
...
void head(int num_processes)
{
    ...
    #pragma omp parallel shared (A,B,C,SZ) private (i,j,k)
    {
        #pragma omp for
